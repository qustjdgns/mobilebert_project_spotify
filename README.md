...
https://www.linkedin.com/pulse/case-study-spotify-transforming-product-development-through-majumder-xzeic
---
...
예측 결과를 보면 전체 리뷰 중 부정 감정이 68.9%로, 긍정(31.1%)보다 훨씬 많은 편이다.
이 수치만 봐도 사용자들이 앱을 이용하면서 불편하거나 아쉬운 점이 많았다는 걸 짐작할 수 있다.
단순히 부정 리뷰가 많다는 사실에서 멈출 게 아니라, 왜 이런 결과가 나왔는지 좀 더 들여다볼 필요가 있다.

실제로 앱에 어떤 문제점이 있었던 건지, 아니면 특정 시기나 앱 버전에서만 이런 반응이 몰렸던 건지 확인해보는 게 중요하다.
이런 분석을 통해 사용자 경험을 저해한 요인이 무엇이었는지 보다 정확하게 파악할 수 있을 것이다.
